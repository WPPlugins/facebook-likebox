<?php
/**
* This File is used to manage like box.
*
* @author  Tech Banker
			...
			<div class="col-md-12">
				<div class="portlet box vivid-green">
					...
					<div class="portlet-body form">
						<form id="ux_frm_manage_like_box">
							<div class="form-body">
								<?php
								...
								<div class="form-actions">
									<div class="table-top-margin">
										...
										<a href="admin.php?page=facebook_likebox" class="btn vivid-green"><?php echo $fbl_add_like_box;?></a>
									</div>
									<div class="line-separator"></div>
									<table class="table table-striped table-bordered table-hover table-margin-top" id="ux_tbl_facebook_likebox">
										<thead>
											<tr>
										...
										<tbody>
											<?php
											foreach($likebox_data_value as $value)
											{
												?>
												<tr>
													<td class="chk-action" style="text-align:center;width: 5%;">
														<input type="checkbox"  name="ux_chk_likebox" id="ux_chk_likebox"  onclick="check_all_facebook_likebox('ux_chk_facebook_all_user');" value="<?php echo isset($value["meta_id"]) ? intval($value["meta_id"]) : ""; ?>">
													</td>
													<td>
														<label class="control-label">
															<strong>
														...
														<label class="control-label">
															...
															<span id="ux_shortcode_<?php echo intval($value['meta_id']); ?>">[facebook_likebox case_type="like_box" fbl_id="<?php echo intval($value['meta_id']); ?>"][/facebook_likebox]</span>
														</label>
													</td>
													<td class="custom-alternative">
														<a href="javascript:void(0);" class="icon-custom-frame tooltips" data-original-title="<?php echo $fbl_preview; ?>" data-placement="top"  onclick='facebook_likebox_preview_likebox("facebook_likebox_preview","<?php echo $facebook_likebox_preview_nonce ?>","likebox_dummy_form","<?php echo intval($value["meta_id"]);  ?>")'></a> |
														...
														<a href="admin.php?page=facebook_likebox&meta_id=<?php echo intval($value["meta_id"]);?>" class="icon-custom-note tooltips" data-original-title="<?php echo $fbl_edit_tooltip; ?>" data-placement="top"></a> |
														<a href="javascript:void(0);" class="icon-custom-trash tooltips custom-delete-icon-custom-live" data-original-title="<?php echo $fbl_delete; ?>" onclick="delete_record_facebook_likebox(<?php echo isset($value["meta_id"]) ? intval($value["meta_id"]) : "";?>,'facebook_manage_like_box','<?php echo $fbl_delete_data_success?>')" data-placement="top"></a>
													</td>
												</tr>
											<?php
											}
