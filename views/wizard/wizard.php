 ...
 *
 * @author  Tech Banker
 * @package  facebook-likebox/views/wizard
 * @version 2.0.0
 */
if (!defined("ABSPATH")) {
    exit;
...
if (!is_user_logged_in()) {
    ...
    if (!$access_granted) {
        ...
        $facebook_likebox_check_status = wp_create_nonce("facebook_likebox_check_status");
        ?>
        <html>
            <body>
                <div><div><div>
                                ...
                                <div class="page-content">
                                    ...
                                    <div class="row row-custom">
                                        <div class="col-md-12 textalign">
                                            ...
                                            <p><strong>Facebook Like Box will still work fine.</strong></p>
                                        </div>
                                    </div>
                                    <div class="row row-custom">
                                        <div class="col-md-12">
                                            <a class="permissions" onclick="show_hide_details_facebook_likebox();">What permissions are being granted?</a>
                                        </div>
                                        ...
                                        <div class="col-md-12 allow">
                                            <div class="tech-banker-actions">
                                                <a onclick="plugin_stats_facebook_likebox('opt_in');" class="button button-primary-wizard">
                                                    <strong>Opt-In &amp; Continue </strong>
                                                    <i class="dashicons dashicons-arrow-right-alt"></i>
                                                </a>
                                                <a onclick="plugin_stats_facebook_likebox('skip');" class="button button-secondary-wizard" tabindex="2">
