<?php
/**
 * This File is used to manage like box popup.
 *
 * @author  Tech Banker
    ...
    if (!$access_granted) {
        ...
        <?php echo $fbl_manage_like_box_popup; ?>
                    ...
                    <div class="portlet-body form">
                        <form id="ux_frm_manage_like_box_popup">
                            <div class="form-body">
                            <?php
            ...
            <?php echo $fbl_important_disclaimer; ?>
                                ...
                                <div class="form-actions">
                                    <div class="table-top-margin">
                                        ...
                                        <a href="admin.php?page=facebook_add_like_box_popup" class="btn vivid-green"><?php echo $fbl_add_like_box_popup; ?></a>
                                    </div>
                                    <div class="line-separator"></div>
                                    <table class="table table-striped table-bordered table-hover table-margin-top" id="ux_tbl_facebook_likebox_box_popup">
                                        <thead>
                                            <tr>
