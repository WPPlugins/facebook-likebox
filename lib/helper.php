...
if (!is_user_logged_in()) {
    ...
    if (!$access_granted) {
        ...
        class plugin_info_facebook_likebox {
            /*
              Function Name: get_plugin_info_facebook_likebox
              Parameters: No
              Decription: This function is used to return the information about plugins.
              Created On: 19-04-2017 04:40
              Created By: Tech Banker Team
             */

            function get_plugin_info_facebook_likebox() {
